...
var _nanoid = __webpack_require__(34);

var _nanoid2 = _interopRequireDefault(_nanoid);

var _TreeNode = __webpack_require__(36);

var _TreeNode2 = _interopRequireDefault(_TreeNode);

var _nodeShape = __webpack_require__(18);
...
_reactDom2.default.render(_react2.default.createElement(_SearchingExample2.default, null), document.getElementById('searching-example'));
...
var _reactCheckboxTree = __webpack_require__(3);
...
var SearchingExample = function (_React$Component) {
    _inherits(SearchingExample, _React$Component);

    function SearchingExample() {
        _classCallCheck(this, SearchingExample);

        var _this = _possibleConstructorReturn(this, (SearchingExample.__proto__ || Object.getPrototypeOf(SearchingExample)).call(this));
        ...
        _this.onCheck = _this.onCheck.bind(_this);
        _this.onExpand = _this.onExpand.bind(_this);
        _this.onFilterMouseUp = _this.onFilterMouseUp.bind(_this);
        return _this;
    }

    _createClass(SearchingExample, [{
        ...
        value: function onFilterMouseUp(e) {
            ...
            var filtered = this.filteredNodes(JSON.parse(JSON.stringify(nodes)), filter, this.defaultMatcher);
            return this.setState({ nodes: filtered });
        }
    }, {
        key: 'defaultMatcher',
        value: function defaultMatcher(node, filter) {
            return node.label.trim().toLowerCase().indexOf(filter.toLowerCase()) !== -1;
        }
    }, {
        key: 'filteredNodes',
        value: function filteredNodes(nodes, filter, matcher) {
            var _this2 = this;
            ...
            return nodes.filter(function (node) {
                if (matcher(node, filter)) {
                    ...
                    _this2.setState({ expanded: expanded });
                    if (node.children && node.children.length) {
                        var children = node.children.filter(function (child) {
                            return matcher(child, filter);
                        });
                    ...
                    if (node.children && node.children.length) {
                        var _children = node.children.filter(function (child) {
                            return matcher(child, filter);
                        });
                        if (_children.length > 0) {
                            expanded.push(node.value);
                            _this2.setState({ expanded: expanded });
                            Object.assign(node, { children: _children });
                            return true;
                        }
                        return false;
                    }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'span',
                        { className: 'input-group-addon', id: 'search-bar' },
    ...
    return SearchingExample;
}(_react2.default.Component);

exports.default = SearchingExample;
