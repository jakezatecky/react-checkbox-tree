    ...
    renderTreeNodes(nodes, parent, checkedArray = [], forceDisabled = false) {
        ...
        const treeNodes = nodes.map((node) => {
            ...
            */
            ...
            if (onlyLeafCheckboxes) { // overrides node.showCheckbox
